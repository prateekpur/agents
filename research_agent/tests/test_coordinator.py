...
from src.models import Question, Answer, AgentMessage, Source, SourceType


@pytest.fixture
def mock_agents():
    """Create mock agents."""
    with patch('src.coordinator.ResearcherAgent') as researcher, \
        ...
        researcher_instance.process = AsyncMock(return_value=AgentMessage(
        ...
        fact_checker_instance.process = AsyncMock(return_value=AgentMessage(
            agent_name="fact_checker",
            content="Facts are verified and accurate",
            sources=[]
        ))
        ...
        synthesizer_instance.process = AsyncMock(return_value=AgentMessage(
...
class TestCoordinatorAgent:
    ...
    def test_calculate_confidence_high(self, mock_agents):
        ...
        fact_check_content = "The information is verified and accurate. All sources are reliable and confirmed."
    ...
    def test_calculate_confidence_low(self, mock_agents):
        ...
        fact_check_content = "The information is uncertain and unverified. Sources are questionable."
        confidence = coordinator._calculate_confidence(fact_check_content)
